    ...
    <div class="leading-loose ">
        ...
        <form class="max-w-xl m-4 p-10 bg-white rounded shadow-xl" method="POST" action="{{ route('profile.store') }}">
            ...
            <div class="inline-block mt-2 -mx-1 pl-1 w-1/2">
                ...
                <input class="w-full px-2 py-2 text-gray-700 bg-gray-200 rounded" id="bloodGroup" name="bloodGroup"
                    type="text" required="" placeholder="bloodGroup" aria-label="Email">
            </div>
            {{-- <div class="">
