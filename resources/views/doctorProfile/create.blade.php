...
@section('content')
    ...
    <div class="leading-loose ">
        ...
        <form class="max-w-xl m-4 p-10 bg-white rounded shadow-xl" method="POST"
            ...
            <div class="mt-2">
                <label class="hidden text-sm block text-gray-600" for="StateId">Role</label>
                <input class="w-full px-2 py-2 text-gray-700 bg-gray-200 rounded" id="roleJob_id" name="roleJob_id"
                    type="number" required="" placeholder="Role">
            </div>
