...
<html>
	...
	<head>
		...
		<script type="text/javascript" src="{{asset('dd/js/jquery.js')}}"></script>
		<script type="text/javascript" src="{{asset('dd/js/bootstrap.min.js')}}"></script>
		<script type="text/javascript" src="{{asset('dd/js/timer.js')}}"></script>
		<script type="text/javascript" src="{{asset('dd/js/script.js')}}"></script>
		<link rel="stylesheet" type="text/css" href="{{asset('dd/css/bootstrap.css')}}">
		<link rel="stylesheet" type="text/css" href="{{asset('dd/css/bootstrap.min.css')}}">
		<link rel="stylesheet" type="text/css" href="{{asset('dd/css/font-awesome.min.css')}}">
		<link href='http://fonts.googleapis.com/css?family=Lobster' rel='stylesheet' type='text/css'>
		<link rel="stylesheet" type="text/css" href="{{asset('dd/css/custom.css')}}">
	</head>
		...
		<div id="myCarousel" class="carousel slide" data-ride="carousel">
		    ...
		    <div class="carousel-inner">
		    	<div class= "container timer">
			    	...
			    	<div class= "row timer-circle">
			    		<div class= "main-text text-center">
			    			<h2 class="top-text">Season - One Page Responsive</h2>
						...
						<div class= "col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
							<div class= "circle text-center">
								<div class= "row" id= "spacer1">
									<div class= "title">5555</div>
									<div class= "numbers" id= "dday">55</div>
								</div>
		        ...
		        <div class="item active">
		        	<img src="{{asset('dd/img/summer.jpg')}}" alt="First slide">
		        ...
		        <div class="item">
		          	<img src="{{asset('dd/img/rainy_season.jpg')}}" alt="Second slide">
		        ...
		        <div class="item">
			        <img src="{{asset('dd/img/winter_season.jpg')}}" alt="Third slide">
			...
			<div class="container">
				<div class="row text-center">
					...
					<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 text-center">
						<div class="copyright">
							&copy; Copyright 2014 Theme Wagon.
						</div>
					</div>
